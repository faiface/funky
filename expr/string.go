...
func (s *Strict) leftString() string { return s.String() }
...
func (s *Strict) rightString() string { return s.String() }
...
func (s *Strict) String() string { return fmt.Sprintf("(strict %v)", s.Expr) }
